...
public class FrmModifyItem<PaymentType> extends JDialog implements ActionListener {
	...
	public FrmModifyItem(JFrame f, String s, boolean b) {
		super(f, s, b);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == this.btnCancel) {
			...
			try {
				...
				PaymentManager.ChangePayment(tp);
				this.setVisible(false);
